...
navigator.geolocation.getCurrentPosition(function showLocation(position) {
  ...
  search(locres); //////this is where i get the long and lat, locally on machine and limit it to 4 decimals
  locationname()
  render()
  resetDaily()
},function(error){
